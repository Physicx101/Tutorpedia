...
public class MyAdapterEventBeneran extends RecyclerView.Adapter<MyAdapterEventBeneran.ViewHolder> {
        ...
        public MyAdapterEventBeneran(List<ListEventItemBeneran> listItems, Context context) {
            this.listItems = listItems;
            this.context = context;
        }

    @Override
    public MyAdapterEventBeneran.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_eventbeneran,parent,false);
        ...
        @Override
        public void onBindViewHolder(MyAdapterEventBeneran.ViewHolder holder, int position) {
